...
import { FormLabel,Input,Button,useColorModeValue,Box } from "@chakra-ui/react"
...
const Contact = () =>{
  ...
  const sendsms=(e)=>{
    ...
    emailjs.sendForm('service_8do9p6k', 'template_raqx7cs', form.current, 'nKW55CVgGgpIZVV1m')
      .then((result) => {
 ...
 return(
    <div id="contact" className={Styles.contactparent}>
      ...
      <Box m="auto" backgroundColor="black" w="80%" borderRadius="20px" pb="20px" pt="20px" pl="20px">
        <form ref={form} onSubmit={sendsms}>
      <FormLabel fontSize="30px">Name</FormLabel>
      <Input focusBorderColor='pink.400' h="20px" type="text" name="user_name" />
      <FormLabel fontSize="30px">Email</FormLabel>
      <Input h="20px" type="email" name="user_email" />
      <FormLabel fontSize="30px">Message</FormLabel>
      <textarea name="message" /><br/>
      <Button h="30px" w="20%"  backgroundColor="skyblue" type="submit">{<FiSend />}</Button></form>                                                                                                                      
        </Box>
      <div>
      ...
      <div className={Styles.soc}>
          ...
          <a href="akjaat001kuntal@gmail.com" target="blank" title="mail">
            <svg
              viewBox="0 0 8 6"
