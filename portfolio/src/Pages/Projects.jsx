  ...
  return (
    <div className={Styles.projectparent}>
      ...
      <div>
        ...
        <div>
          <div>
            <h1>EngageBay Clone</h1>
          </div>
          <div className={Styles.para}>
          EngageBay CE is a cloud-based platform and extended functionality of the EngageBay suite. It offers a robust customer engagement solution for small to mid-sized businesses.
          </div>
          ...
          <div className={Styles.prosvg}>
            <a
              href="https://github.com/Sakil9051/brawny-base-7995/tree/main/engagebay-clone-328"
              target="_blank"
            ...
            <a
              href="https://brawny-base-7995-6r5h.vercel.app/"
              target="_blank"
              rel="nofollow noopener noreferrer"
      ...
      <div className={Styles.myntraimg}>
        ...
        <div>
          ...
          <div className={Styles.prosvg}>
            <a
              href="https://github.com/raghavendra7992/myntra"
              target="_blank"
              rel="nofollow noopener noreferrer"
              aria-label="GitHub Link"
            >
            ...
            <a
              href="https://boisterous-concha-36b0a6.netlify.app/"
              target="_blank"
              rel="nofollow noopener noreferrer"
              aria-label="External Link"
            >
      ...
      <div className={Styles.swiggyimg}>
          ...
          <div>
            <h1>Indian Express Clone</h1>
            <div className={Styles.para}>
            ounded by Shri Ramnath Goenka in 1932 , The Indian Express gave voice to INDIAN and express there opinion opinion that was fearless and true. I cloned it for my construct week Project.
            </div>
            <div className={Styles.li}>
              <li>React</li>
              <li>CSS</li>
            ...
            <div className={Styles.prosvg}>
              <a
                href="https://github.com/raghavendra7992/abiding-cough-9521"
                target="_blank"
                rel="nofollow noopener noreferrer"
                aria-label="GitHub Link"
              >
              ...
              <a
                href="https://indianexpressclonebysingh.netlify.app"
                target="_blank"
                rel="nofollow noopener noreferrer"
                aria-label="External Link"
              >
      ...
      <div className={Styles.blueimg}>
          ...
          <div>
            ...
            <div className={Styles.prosvg}>
              <a
                href="https://github.com/Ashukla011/perfect-business-7811"
                target="_blank"
                rel="nofollow noopener noreferrer"
                aria-label="GitHub Link"
              >
              ...
              <a
                href="https://darling-basbousa-b508b0.netlify.app/"
                target="_blank"
                rel="nofollow noopener noreferrer"
                aria-label="External Link"
              >
